...
function getWelcomeName(user) {
  ...
  const segment = localPart.split(/[._-]/).find(Boolean) || localPart;
...
export default function App() {
  ...
  const welcomeBanner = user ? (
    <div className="welcome-banner panel" aria-live="polite">
  ...
  if (selectedProjectId) {
    return <>{floatingControls}{welcomeBanner}<ProjectView projectId={selectedProjectId} user={user} onBack={() => { setSelectedProjectId(null); loadProjects(); }} /></>;
  }
