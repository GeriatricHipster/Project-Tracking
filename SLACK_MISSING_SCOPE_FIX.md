...
If you still see a `missing_scope` error after uploading this package, Render is probably still running an older deployment. Go to Render, open the BuildTrack service, and click **Manual Deploy** or **Clear build cache & deploy**.
