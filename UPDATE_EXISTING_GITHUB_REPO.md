...
```text
Add completed projects, delete, assignments, and calendar tabs
```
...
The Assignments tab uses the project members you add inside each project. The Calendar tab uses each project's start date, finish date, task progress, blocked tasks, and completed/active filing status. Finished projects can be moved to the Completed tab, restored to Active, or permanently deleted by an owner.
